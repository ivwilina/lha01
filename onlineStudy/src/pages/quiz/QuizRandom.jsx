...
const QuizRandom = () => {
  ...
  useEffect(() => {
    ...
    const createQuiz = async () => {
      try {
        ...
        // Create random quiz
        const newQuiz = await createRandomQuiz(numQuestions);
        setQuiz(newQuiz);
        ...
        console.error('Error creating random quiz:', err);
        setError(err.message || 'Không thể tạo quiz ngẫu nhiên');
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmitQuiz = useCallback(async () => {
    try {
      ...
      // Submit quiz (no specific categoryId for random quiz)
  ...
  if (showResults && results) {
    return (
      <QuizResults 
        results={results}
        category={{ categoryTopic: 'Random Quiz - All Available Words' }}
    ...
    <div className="quiz-layout">
      ...
      <div className="quiz-main-content">
        <div className="quiz-header">
          <h2>Random Quiz</h2>
          <p className="quiz-description">Random vocabulary from all available words</p>
        </div>
