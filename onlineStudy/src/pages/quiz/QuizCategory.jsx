...
const QuizCategory = () => {
  ...
  useEffect(() => {
    ...
    const createQuiz = async () => {
      try {
        ...
        const newQuiz = await createCategoryQuiz(categoryId, currentUser._id, numQuestions);
        setQuiz(newQuiz);
  ...
  const handleSubmitQuiz = useCallback(async () => {
    try {
      ...
      // Submit quiz
      const quizResults = await submitQuiz(quiz._id, formattedAnswers, currentUser._id, categoryId);
